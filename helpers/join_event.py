...
def handle_join_event(ack, body, botclient):
    ...
    if channel_id == "C04DSP005D2": #0-getting-started channel
        ...
        response = botclient.chat_postMessage(
            channel = "C05DVASKFDW", #internal-join-notifications
...
We’d love to hear more about you in <#C05QFC7BCGK|5-introduce-yourself>.
